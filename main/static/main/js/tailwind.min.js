...
(() => {
  var e = 10;
  function t(t, o) {
    let i = o?.from ? { file: o.from, code: t } : null;
    "\ufeff" === t[0] && (t = " " + t.slice(1));
    let a,
      l = [],
      s = [],
    ...
    for (let o = 0; o < t.length; o++) {
      ...
      if (13 !== m || ((a = t.charCodeAt(o + 1)), a !== e))
        if (92 === m) "" === f && (h = o), (f += t.slice(o, o + 2)), (o += 1);
        else if (47 === m && 42 === t.charCodeAt(o + 1)) {
          let e = o;
          for (let e = o + 2; e < t.length; e++)
            if (((a = t.charCodeAt(e)), 92 === a)) e += 1;
            else if (42 === a && 47 === t.charCodeAt(e + 1)) {
              o = e + 1;
              break;
            }
          let r = t.slice(e, o + 1);
          if (33 === r.charCodeAt(2)) {
            let t = x(r.slice(2, -2));
            s.push(t), i && ((t.src = [i, e, o + 1]), (t.dst = [i, e, o + 1]));
          }
        } else if (39 === m || 34 === m) {
          let r = o;
          for (let n = o + 1; n < t.length; n++)
            if (((a = t.charCodeAt(n)), 92 === a)) n += 1;
            else {
              if (a === m) {
                o = n;
                break;
              ...
              if (
                59 === a &&
                (t.charCodeAt(n + 1) === e ||
                  (13 === t.charCodeAt(n + 1) && t.charCodeAt(n + 2) === e))
              )
                throw new Error(
                  `Unterminated string: ${
                    t.slice(r, n + 1) + String.fromCharCode(m)
                  }`
                );
              if (a === e || (13 === a && t.charCodeAt(n + 1) === e))
                throw new Error(
                  `Unterminated string: ${
                    t.slice(r, n) + String.fromCharCode(m)
                  }`
                );
            }
          f += t.slice(r, o + 1);
          ...
          if (
            ...
            (32 === a ||
              a === e ||
              9 === a ||
              (13 === a && (a = t.charCodeAt(o + 2)) && a == e))
          )
            continue;
          if (m === e) {
            if (0 === f.length) continue;
            (a = f.charCodeAt(f.length - 1)),
              32 !== a && a !== e && 9 !== a && (f += " ");
          } else if (45 === m && 45 === t.charCodeAt(o + 1) && 0 === f.length) {
            let e = "",
              r = o,
              s = -1;
            for (let n = o + 2; n < t.length; n++)
              if (((a = t.charCodeAt(n)), 92 === a)) n += 1;
              else if (47 === a && 42 === t.charCodeAt(n + 1)) {
              ...
              } else if (-1 === s && 58 === a) s = f.length + n - r;
              else {
                if (59 === a && 0 === e.length) {
                  (f += t.slice(r, n)), (o = n);
                  break;
                ...
                if (40 === a) e += ")";
                  ...
                  if ((125 === a || t.length - 1 === n) && 0 === e.length) {
                    (o = n - 1), (f += t.slice(r, n));
                    break;
                  }
                  (41 === a || 93 === a || 125 === a) &&
            ...
            i && ((c.src = [i, r, o]), (c.dst = [i, r, o])),
              u ? u.nodes.push(c) : l.push(c),
              (f = "");
          } else if (59 === m && 64 === f.charCodeAt(0))
            (d = r(f)),
              i && ((d.src = [i, h, o]), (d.dst = [i, h, o])),
              u ? u.nodes.push(d) : l.push(d),
              (f = ""),
              (d = null);
          else if (59 === m && ")" !== p[p.length - 1]) {
            let e = n(f);
            if (!e)
              throw 0 === f.length
                ? new Error("Unexpected semicolon")
                : new Error(`Invalid declaration: \`${f.trim()}\``);
            i && ((e.src = [i, h, o]), (e.dst = [i, h, o])),
              u ? u.nodes.push(e) : l.push(e),
              (f = "");
          } else if (123 === m && ")" !== p[p.length - 1])
            (p += "}"),
              (d = b(f.trim())),
              i && ((d.src = [i, h, o]), (d.dst = [i, h, o])),
              u && u.nodes.push(d),
              ...
              (f = ""),
              (d = null);
          else if (125 === m && ")" !== p[p.length - 1]) {
            if ("" === p) throw new Error("Missing opening {");
            if (((p = p.slice(0, -1)), f.length > 0))
              if (64 === f.charCodeAt(0))
                (d = r(f)),
                  i && ((d.src = [i, h, o]), (d.dst = [i, h, o])),
                  u ? u.nodes.push(d) : l.push(d),
                  (f = ""),
                ...
                if (u) {
                  ...
                  i && ((t.src = [i, h, o]), (t.dst = [i, h, o])),
                    u.nodes.push(t);
                }
              }
            let e = c.pop() ?? null;
            null === e && u && l.push(u), (u = e), (f = ""), (d = null);
          } else if (40 === m) (p += ")"), (f += "(");
          else if (41 === m) {
            if (")" !== p[p.length - 1]) throw new Error("Missing opening (");
            (p = p.slice(0, -1)), (f += ")");
          } else {
            if (0 === f.length && (32 === m || m === e || 9 === m)) continue;
            "" === f && (h = o), (f += String.fromCharCode(m));
          }
        }
    }
    if (64 === f.charCodeAt(0)) {
      let e = r(f);
      i && ((e.src = [i, h, t.length]), (e.dst = [i, h, t.length])), l.push(e);
    }
    if (p.length > 0 && u) {
      if ("rule" === u.kind)
        throw new Error(`Missing closing } at ${u.selector}`);
      if ("at-rule" === u.kind)
        throw new Error(`Missing closing } at ${u.name} ${u.params}`);
    }
    return s.length > 0 ? s.concat(l) : l;
  }
  function r(e, t = []) {
    let r = e,
      n = "";
  ...
  function l(e, t) {
    return (a.get(t) ?? []).some((t) => e === t || e.startsWith(`${t}-`));
  }
  var s = class {
  ...
  function A(e, t, r = [], n = {}) {
    for (let o = 0; o < e.length; o++) {
      let i = e[o],
        a = r[r.length - 1] ?? null;
      if ("context" === i.kind) {
        if (2 === A(i.nodes, t, r, { ...n, ...i.context })) return 2;
        continue;
      }
      r.push(i);
      let l = !1,
  ...
  function j(e, t, r = 3) {
    ...
    function v(e, c, p = {}, h = 0) {
      if ("declaration" === e.kind) {
        ...
        2 & r && e.value.includes("color-mix(") && a.get(c).add(e), c.push(e);
      } else if ("rule" === e.kind)
        if ("&" === e.selector)
        ...
        if (1 & r) {
          ...
          let o = y(t, r ?? "initial");
          (o.src = e.src), n ? u.push(o) : d.push(o);
        }
        o.add(e.params);
        let t = { ...e, nodes: [] };
        for (let r of e.nodes) v(r, t.nodes, p, h + 1);
    ...
    if (1 & r) {
      ...
      if (d.length > 0) {
        let t = b("*, ::before, ::after, ::backdrop", d);
      ...
      if (e.length > 0) {
        let t = w.findIndex(
          ...
          r = k("@layer", "properties", []);
        (r.src = e[0].src), w.splice(t < 0 ? w.length : t, 0, r);
        let n = b("@layer properties", [
          k(
            "@supports",
  ...
  function R(e) {
    if ("[" === e[0] && "]" === e[e.length - 1]) {
      let t = W(e.slice(1, -1));
      return B(t) && 0 !== t.length && 0 !== t.trim().length
        ? { kind: "arbitrary", value: t }
        : null;
    }
    return "(" === e[0] && ")" === e[e.length - 1]
      ? "-" === (e = e.slice(1, -1))[0] && "-" === e[1] && B(e)
        ? { kind: "arbitrary", value: W((e = `var(${e})`)) }
        : null
      : { kind: "named", value: e };
  }
  function* P(e, t) {
  ...
  function H(e) {
    ...
    return (
      "compound" === e.kind && ((t += e.root), (t += "-"), (t += H(e.variant))),
      ...
      switch (t.kind) {
        case "function":
          ...
          if (
            ...
            t.value = te(t.value);
            for (let e = 0; e < t.nodes.length; e++) J([t.nodes[e]]);
            break;
          }
          (t.value = te(t.value)), J(t.nodes);
          break;
        case "separator":
          t.value = te(t.value);
          break;
  ...
  var ne = new Set([
    ...
    oe = /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix)\(/i;
  var ie = {
    color: function (e) {
      return 35 === e.charCodeAt(0) || oe.test(e) || ne.has(e.toLowerCase());
    },
    length: we,
    percentage: me,
    ratio: function (e) {
      return ge.test(e) || F(e);
    },
    number: pe,
    integer: ye,
    url: se,
    ...
    "bg-size": function (e) {
      ...
      for (let r of I(e, ",")) {
        ...
        e.every((e) => "auto" === e || we(e) || me(e)) && (t += 1);
      }
      return t > 0;
    },
    "line-width": function (e) {
      return I(e, " ").every(
        (e) => we(e) || pe(e) || "thin" === e || "medium" === e || "thick" === e
      );
    },
    image: function (e) {
      let t = 0;
  ...
  function ae(e, t) {
    ...
    for (let r of t) if (ie[r]?.(e)) return r;
    return null;
  }
  var le = /^url\(.*\)$/;
  function se(e) {
  ...
  var ce = /^(?:element|image|cross-fade|image-set)\(/,
    ue = /^(repeating-)?(conic|linear|radial)-gradient\(/;
  var de = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
    fe = new RegExp(`^${de.source}$`);
  function pe(e) {
    return fe.test(e) || F(e);
  }
  var he = new RegExp(`^${de.source}%$`);
  function me(e) {
    return he.test(e) || F(e);
  }
  var ge = new RegExp(`^${de.source}s*/s*${de.source}$`);
  var ve = new RegExp(
    `^${de.source}(${[
      "cm",
      "mm",
  ...
  function we(e) {
    return ve.test(e) || F(e);
  }
  var ke = new RegExp(
    `^${de.source}(${["deg", "rad", "grad", "turn"].join("|")})$`
  );
  var be = new RegExp(`^${de.source} +${de.source} +${de.source}$`);
  function ye(e) {
    let t = Number(e);
  ...
  var Ce = new Set(["inset", "inherit", "initial", "revert", "unset"]),
    je = /^-?(\d+|\.\d+)(.*?)$/g;
  function Te(e, t) {
    return I(e, ",")
      .map((e) => {
        let r = I((e = e.trim()), " ").filter((e) => "" !== e.trim()),
          n = null,
          o = null,
          i = null;
        for (let e of r)
  ...
  function We(e, t, r) {
    if (!t) return e;
    if ("arbitrary" === t.kind) return Oe(e, t.value);
    let n = r.resolve(t.value, ["--opacity"]);
    return n ? Oe(e, n) : ze(t.value) ? Oe(e, `${t.value}%`) : null;
  }
  function Ue(e, t, r) {
    let n = null;
    ...
    return n ? We(n, e.modifier, t) : null;
  }
  var De = /(\d+)_(\d+)/g;
    ...
    for (let n of t.nodes) {
      ...
      if (
        ...
        if ("named" === e.kind && "word" === n.kind) {
          ...
          if ("ratio" === r) {
            let [e, r] = I(t, "/");
            if (!ye(e) || !ye(r)) continue;
          } else {
            if ("number" === r && !$e(t)) continue;
            if ("percentage" === r && !ye(t.slice(0, -1))) continue;
          }
        ...
        if (
          ...
          if (null !== ae(e.value, [t])) return { nodes: m(e.value) };
        }
      }
    }
  }
  function Be(e, t, r, n, o = "") {
    ...
    return i
      ? [
          y(e, l(Te(t, n))),
          b("@supports (color: lab(from red l a b))", [y(e, l(a))]),
        ]
      : [y(e, l(a))];
  }
  function Le(e, t, r, n, o = "") {
    ...
    return i
      ? [
          ...
          b("@supports (color: lab(from red l a b))", [y(e, o + a)]),
        ]
      : [y(e, o + a)];
  }
  var Ie = {
    "--alpha": function (e, t, r, ...n) {
      let [o, i] = I(r, "/").map((e) => e.trim());
      if (!o || !i)
        throw new Error(
  ...
  function Pe(e, t) {
    ...
    return (
      A(e, (e) => {
        if ("declaration" === e.kind && e.value && Re.test(e.value))
  ...
  function qe(e, t, r) {
    ...
    return (
      p(n, (e, { replaceWith: n }) => {
        if ("function" === e.kind && e.value in Ie) {
          let o = I(h(e.nodes).trim(), ",").map((e) => e.trim());
          return n(m(Ie[e.value](r, t, ...o)));
        }
      }),
      h(n)
    );
  ...
  function tt(e) {
    let t = (function (e) {
          ...
          t.functional(n, (t) => {
            ...
            return (
              "arbitrary" === t.value.kind
                ? ((r = t.value.value), (r = We(r, t.modifier, e)))
                : (r = Ue(t, e, o.themeKeys)),
        ...
        n("isolate", [["isolation", "isolate"]]),
          ...
          o("z", {
            supportsNegative: !0,
            handleBareValue: ({ value: e }) => (ye(e) ? e : null),
            themeKeys: ["--z-index"],
        ...
        let l = () =>
          z([
            Ne("--tw-border-spacing-x", "0", "<length>"),
            Ne("--tw-border-spacing-y", "0", "<length>"),
          ]);
          ...
          return (r) => {
            ...
            return "arbitrary" === r.value.kind
              ...
              : ((n = e.resolve(r.value.value, ["--scale"])),
                !n && ye(r.value.value) && (n = `${r.value.value}%`),
                n
                  ? ((n = t ? `calc(${n} * -1)` : n),
                    [
                      c(),
        ...
        function d({ negative: t }) {
          return (r) => {
            ...
            if ("arbitrary" === r.value.kind) {
              ...
              !n && ye(r.value.value) && (n = `${r.value.value}deg`),
              !n)
            )
              return;
            return [y("rotate", t ? `calc(${n} * -1)` : n)];
          ...
          ]);
        {
          ...
          for (let t of ["x", "y", "z"])
            o(`rotate-${t}`, {
              supportsNegative: !0,
              themeKeys: ["--rotate"],
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}deg` : null),
              handle: (r) => [
                i(),
        ...
        let f = () =>
          z([Ne("--tw-pan-x"), Ne("--tw-pan-y"), Ne("--tw-pinch-zoom")]);
        ...
        let p = () => z([Ne("--tw-scroll-snap-strictness", "proximity", "*")]);
        ...
        n("grid-flow-row", [["grid-auto-flow", "row"]]),
          ...
          a("gap-x", ["--gap", "--spacing"], (e) => [y("column-gap", e)]),
          a("gap-y", ["--gap", "--spacing"], (e) => [y("row-gap", e)]),
          a(
            "space-x",
            ["--space", "--spacing"],
            (e) => [
              z([Ne("--tw-space-x-reverse", "0")]),
          ...
          ]);
        {
          let i = function (n, o) {
              t.functional(n, (t) => {
                ...
                {
                  let r = Ue(t, e, ["--border-color", "--color"]);
          ...
          i("border", {
            ...
            o("divide-x", {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}px` : null),
              handle: (e) => [
                z([Ne("--tw-divide-x-reverse", "0")]),
                w(":where(& > :not(:last-child))", [
        ...
        t.functional("bg", (t) => {
          if (t.value) {
            ...
            {
              let r = Ue(t, e, ["--background-color", "--color"]);
        ...
        let h = () =>
          z([
            Ne("--tw-gradient-position"),
            Ne("--tw-gradient-from", "#0000", "<color>"),
            Ne("--tw-gradient-via", "#0000", "<color>"),
            Ne("--tw-gradient-to", "#0000", "<color>"),
            Ne("--tw-gradient-stops"),
            Ne("--tw-gradient-via-stops"),
            Ne("--tw-gradient-from-position", "0%", "<length-percentage>"),
            Ne("--tw-gradient-via-position", "50%", "<length-percentage>"),
            Ne("--tw-gradient-to-position", "100%", "<length-percentage>"),
          ]);
        function m(n, o) {
          t.functional(n, (t) => {
            if (t.value) {
        ...
        let g = () =>
          z([
            Ne("--tw-mask-linear", "linear-gradient(#fff, #fff)"),
            Ne("--tw-mask-radial", "linear-gradient(#fff, #fff)"),
            Ne("--tw-mask-conic", "linear-gradient(#fff, #fff)"),
          ]);
        function v(n, o) {
          t.functional(n, (t) => {
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  case "percentage":
                    return t.modifier || !ye(r.slice(0, -1))
                      ? void 0
                      : o.position(r);
                  default:
                    return t.modifier ? void 0 : o.position(r);
              ...
              }
              {
                ...
                switch (r) {
                  case "number": {
                    let r = e.resolve(null, ["--spacing"]);
                    return r && $e(t.value.value)
                      ? o.position(`calc(${r} * ${t.value.value})`)
                      : void 0;
                  }
                  case "percentage":
                    return ye(t.value.value.slice(0, -1))
        ...
        let x = () =>
          z([
            Ne("--tw-mask-left", "linear-gradient(#fff, #fff)"),
            Ne("--tw-mask-right", "linear-gradient(#fff, #fff)"),
            Ne("--tw-mask-bottom", "linear-gradient(#fff, #fff)"),
            Ne("--tw-mask-top", "linear-gradient(#fff, #fff)"),
          ]);
        function $(e, t, r) {
          v(e, {
            color(e) {
              ...
              for (let o of ["top", "right", "bottom", "left"])
                r[o] &&
                  ...
                  n.push(
                    z([
                      Ne(`--tw-mask-${o}-from-position`, "0%"),
                      Ne(`--tw-mask-${o}-to-position`, "100%"),
                      Ne(`--tw-mask-${o}-from-color`, "black"),
                      Ne(`--tw-mask-${o}-to-color`, "transparent"),
                    ])
                  ),
        ...
        let A = () =>
          z([
            Ne("--tw-mask-linear-position", "0deg"),
            Ne("--tw-mask-linear-from-position", "0%"),
            Ne("--tw-mask-linear-to-position", "100%"),
            Ne("--tw-mask-linear-from-color", "black"),
            Ne("--tw-mask-linear-to-color", "transparent"),
          ]);
        o("mask-linear", {
          defaultValue: null,
          supportsNegative: !0,
          supportsFractions: !1,
          handleBareValue: (e) =>
            ye(e.value) ? `calc(1deg * ${e.value})` : null,
        ...
        let C = () =>
          z([
            Ne("--tw-mask-radial-from-position", "0%"),
            Ne("--tw-mask-radial-to-position", "100%"),
            Ne("--tw-mask-radial-from-color", "black"),
            Ne("--tw-mask-radial-to-color", "transparent"),
            Ne("--tw-mask-radial-shape", "ellipse"),
            Ne("--tw-mask-radial-size", "farthest-corner"),
            Ne("--tw-mask-radial-position", "center"),
          ]);
        ...
        let j = () =>
          z([
            Ne("--tw-mask-conic-position", "0deg"),
            Ne("--tw-mask-conic-from-position", "0%"),
            Ne("--tw-mask-conic-to-position", "100%"),
            Ne("--tw-mask-conic-from-color", "black"),
            Ne("--tw-mask-conic-to-color", "transparent"),
          ]);
        o("mask-conic", {
          defaultValue: null,
          supportsNegative: !0,
        ...
        n("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
          ...
          t.functional("fill", (t) => {
            if (!t.value) return;
            if ("arbitrary" === t.value.kind) {
              let r = We(t.value.value, t.modifier, e);
              return null === r ? void 0 : [y("fill", r)];
            }
            let r = Ue(t, e, ["--fill", "--color"]);
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  default:
                    return (
                      (r = We(t.value.value, t.modifier, e)),
                      null === r ? void 0 : [y("stroke", r)]
                    );
                }
              }
              {
                let r = Ue(t, e, ["--stroke", "--color"]);
        ...
        n("text-left", [["text-align", "left"]]),
          ...
          o("font-stretch", {
            handleBareValue: ({ value: e }) => {
              ...
              return !ye(t) || Number.isNaN(t) || t < 50 || t > 200 ? null : e;
            },
          ...
          t.functional("decoration", (t) => {
            if (t.value) {
              ...
              {
                let r = Ue(t, e, ["--text-decoration-color", "--color"]);
          ...
          });
        {
          let i = [
            ...
            l = () =>
              z([
                ...
                Ne("--tw-sepia"),
                Ne("--tw-drop-shadow"),
                Ne("--tw-drop-shadow-color"),
                Ne("--tw-drop-shadow-alpha", "100%", "<percentage>"),
                Ne("--tw-drop-shadow-size"),
              ]),
            s = () =>
              z([
                Ne("--tw-backdrop-blur"),
                Ne("--tw-backdrop-brightness"),
                Ne("--tw-backdrop-contrast"),
                Ne("--tw-backdrop-grayscale"),
                Ne("--tw-backdrop-hue-rotate"),
                Ne("--tw-backdrop-invert"),
                Ne("--tw-backdrop-opacity"),
                Ne("--tw-backdrop-saturate"),
                Ne("--tw-backdrop-sepia"),
              ]);
          t.functional("filter", (e) => {
            ...
            t.functional("drop-shadow", (t) => {
              ...
              if (
                (t.modifier &&
                  ("arbitrary" === t.modifier.kind
                    ? (r = t.modifier.value)
                    : ye(t.modifier.value) && (r = `${t.modifier.value}%`)),
                !t.value)
              ) {
              ...
              {
                let r = Ue(t, e, ["--drop-shadow-color", "--color"]);
                if (r)
                  return "inherit" === r
                    ? [
                        l(),
            ...
            o("backdrop-opacity", {
              ...
              handleBareValue: ({ value: e }) => (ze(e) ? `${e}%` : null),
              handle: (e) => [
                s(),
        ...
        }
        {
          ...
          n("transition-none", [["transition-property", "none"]]),
            ...
            o("delay", {
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}ms` : null),
              themeKeys: ["--transition-delay"],
              handle: (e) => [y("transition-delay", e)],
            });
          {
            let r = () => z([Ne("--tw-duration")]);
          ...
          let e =
            ...
            t = () =>
              z([
                Ne("--tw-ordinal"),
                Ne("--tw-slashed-zero"),
                Ne("--tw-numeric-figure"),
                Ne("--tw-numeric-spacing"),
                Ne("--tw-numeric-fraction"),
              ]);
        ...
        {
          let i = () => z([Ne("--tw-outline-style", "solid")]);
          t.static("outline-hidden", () => [
            ...
            t.functional("outline", (t) => {
              ...
              {
                let r = Ue(t, e, ["--outline-color", "--color"]);
        ...
        let T = () =>
          z([
            Ne("--tw-text-shadow-color"),
            Ne("--tw-text-shadow-alpha", "100%", "<percentage>"),
          ]);
        n("text-shadow-initial", [T, ["--tw-text-shadow-color", "initial"]]),
          t.functional("text-shadow", (t) => {
            ...
            switch (t.value.value) {
              case "none":
                return t.modifier ? void 0 : [T(), y("text-shadow", "none")];
              case "inherit":
                return t.modifier
                  ? void 0
                  : [T(), y("--tw-text-shadow-color", "inherit")];
            }
            {
            ...
            {
              let r = Ue(t, e, ["--text-shadow-color", "--color"]);
              if (r)
                return [
                  T(),
                  y(
                    "--tw-text-shadow-color",
                    Oe(r, "var(--tw-text-shadow-alpha)")
                  ),
                ];
            }
          }),
          ...
          ]);
        {
          let o = function (e) {
            ...
            s = () =>
              z([
                Ne("--tw-shadow", l),
                Ne("--tw-shadow-color"),
                Ne("--tw-shadow-alpha", "100%", "<percentage>"),
                Ne("--tw-inset-shadow", l),
                Ne("--tw-inset-shadow-color"),
                Ne("--tw-inset-shadow-alpha", "100%", "<percentage>"),
                Ne("--tw-ring-color"),
                Ne("--tw-ring-shadow", l),
                Ne("--tw-inset-ring-color"),
                Ne("--tw-inset-ring-shadow", l),
                Ne("--tw-ring-inset"),
                Ne("--tw-ring-offset-width", "0px", "<length>"),
                Ne("--tw-ring-offset-color", "#fff"),
                Ne("--tw-ring-offset-shadow", l),
              ]);
            ...
            t.functional("shadow", (t) => {
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), y("--tw-shadow", l), y("box-shadow", a)];
                case "inherit":
                  return t.modifier
                    ? void 0
              ...
              {
                let r = Ue(t, e, ["--box-shadow-color", "--color"]);
                if (r)
                  return [
                    s(),
                    y("--tw-shadow-color", Oe(r, "var(--tw-shadow-alpha)")),
                  ];
              }
            }),
            r("shadow", () => [
            ...
            t.functional("inset-shadow", (t) => {
                    ...
                    null === n
                      ...
                      : [
                          ...
                          y(
                            ...
                            Oe(n, "var(--tw-inset-shadow-alpha)")
                          ),
                        ])
                  : [
                      s(),
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), y("--tw-inset-shadow", l), y("box-shadow", a)];
                case "inherit":
                  return t.modifier
                    ? void 0
              ...
              }
              {
                ...
                if (r)
                  return [
                    ...
                    y(
                      "--tw-inset-shadow-color",
                      Oe(r, "var(--tw-inset-shadow-alpha)")
                    ),
                  ];
              }
            }),
          ...
          t.functional("ring", (t) => {
            if (!t.value) {
              ...
              return [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", a)];
            }
            if ("arbitrary" === t.value.kind) {
              let r = t.value.value;
              return "length" ===
                ...
                ? t.modifier
                  ? void 0
                  : [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", a)]
                : ((r = We(r, t.modifier, e)),
                  null === r ? void 0 : [y("--tw-ring-color", r)]);
            }
            {
              let r = Ue(t, e, ["--ring-color", "--color"]);
            ...
            }
            {
              ...
              if (
                (null === r && ye(t.value.value) && (r = `${t.value.value}px`),
                r)
              )
                return [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", a)];
            }
          ...
          t.functional("ring-offset", (t) => {
            if (t.value) {
              ...
              {
                let r = Ue(t, e, ["--ring-offset-color", "--color"]);
      ...
      r = (function (e) {
        ...
        r("first", ["&:first-child"]),
          ...
          t.functional("aria", (e, t) => {
            ...
            "arbitrary" === t.value.kind
              ? (e.nodes = [w(`&[aria-${Qe(t.value.value)}]`, e.nodes)])
          ...
          t.functional("data", (e, t) => {
            if (!t.value || t.modifier) return null;
            e.nodes = [w(`&[data-${Qe(t.value.value)}]`, e.nodes)];
          }),
          t.functional("nth", (e, t) => {
            if (
              !t.value ||
              t.modifier ||
              ("named" === t.value.kind && !ye(t.value.value))
            )
              return null;
          ...
          r("contrast-less", ["@media (prefers-contrast: less)"]);
        {
          let r = function (e, t, r, n) {
            ...
            let i = n.get(t);
            return null === i ? ("asc" === r ? 1 : -1) : re(o, i, r);
          };
          {
      ...
      n = new c((e) =>
        (function (e, t) {
          if ("[" === e[0] && "]" === e[e.length - 1]) {
            ...
            let t = W(e.slice(1, -1));
            if (!B(t) || 0 === t.length || 0 === t.trim().length) return null;
            let r = ">" === t[0] || "+" === t[0] || "~" === t[0];
            return (
              ...
              switch (t.variants.kind(e)) {
                ...
                case "functional": {
                  ...
                  if ("]" === r[r.length - 1]) {
                    if ("[" !== r[0]) continue;
                    let n = W(r.slice(1, -1));
                    return B(n) && 0 !== n.length && 0 !== n.trim().length
                      ? {
                          kind: "functional",
                          root: e,
                          modifier: t,
          ...
          (function* (e, t) {
            ...
            if (null === l || null !== u)
              if ("[" !== a[0]) {
                ...
                } else c = P(a, (e) => t.utilities.has(e, "functional"));
                for (let [t, r] of c) {
                  let n = {
                    kind: "functional",
                    root: t,
        ...
        let t = (function (e, t) {
          let r = (function (e, t) {
            if ("arbitrary" === e.kind) {
              let r = e.value;
              return (
                e.modifier && (r = We(r, e.modifier, t.theme)),
          ...
          for (let o of r) {
            let r = lt(o);
            (e.important || t.important) && at(o);
            let a = { kind: "rule", selector: i, nodes: o };
      ...
      s = {
        ...
        candidatesToCss(e) {
          ...
          for (let r of e) {
            ...
            (n = j(n, s, 0)), 0 === n.length || e ? t.push(null) : t.push(T(n));
          }
          return t;
        },
        getClassOrder(e) {
          ...
          return (function (e) {
            ...
            for (let [r, n] of e.variants.entries()) {
              let o = function ({ value: t, modifier: n } = {}) {
                ...
                if (null === ot(l, a, e.variants)) return [];
                let s = [];
                return (
                  C(l.nodes, (e, { path: t }) => {
                    if (
        ...
        printCandidate: (e) =>
          (function (e, t) {
            let r = [];
            for (let e of t.variants) r.unshift(H(e));
            ...
            if (
              ...
              if ("arbitrary" === t.value.kind) {
                if (null !== t.value) {
                  let e = Q(t.value.value),
                    r = e ? t.value.value.slice(4, -1) : t.value.value,
                    [o, i] = e ? ["(", ")"] : ["[", "]"];
                  t.value.dataType
                    ? (n += `-${o}${t.value.dataType}:${Y(r)}${i}`)
                    : (n += `-${o}${Y(r)}${i}`);
                }
              } else "named" === t.value.kind && (n += `-${t.value.value}`);
            return (
              "arbitrary" === t.kind && (n += `[${t.property}:${Y(t.value)}]`),
  ...
  function nt(e, t, { onInvalidCandidate: r } = {}) {
    let n = new Map(),
      o = [],
      i = new Map();
    for (let n of e) {
  ...
  function at(e) {
    for (let t of e)
      "at-root" !== t.kind &&
        ("declaration" === t.kind
          ? (t.important = !0)
          : ("rule" === t.kind || "at-rule" === t.kind) && at(t.nodes));
  }
  function lt(e) {
    let t = new Set(),
      r = 0,
          ...
          return (
            ...
            void A(e.nodes, (r) => {
              if ("at-rule" === r.kind && "@apply" === r.name) {
                o.add(e);
                for (let n of ct(r, t)) i.get(e).add(n);
              }
            })
          );
        }
  ...
  async function ut(e, r, n, o = 0, i = !1) {
    let a = 0,
      l = [];
    return (
      A(e, (e, { replaceWith: s }) => {
          ...
          return (
            l.push(
              (async () => {
                ...
                await ut(l, a.base, n, o + 1, i),
                  (g.nodes = (function (e, t, r, n, o) {
                    let i = t;
                    if (null !== r) {
                      let t = k("@layer", r, i);
                      (t.src = e.src), (i = [t]);
                    ...
                    if (null !== o) {
                      let t = k("@supports", "(" === o[0] ? o : `(${o})`, i);
                      (t.src = e.src), (i = [t]);
                    }
                    return i;
                  })(e, [$({ base: a.base }, l)], d, f, p));
              })()
            ),
            s(g),
            1
  ...
  function mt(e, t = [], r) {
    for (let n of Reflect.ownKeys(e)) {
      ...
      if (1 !== a) {
        if (2 === a) return 2;
        if ((Array.isArray(o) || "object" == typeof o) && 2 === mt(o, i, r))
          return 2;
      }
    }
  }
  ...
  function kt(e, t, r) {
    return function (n, o) {
      ...
      let s = (() => {
        let o = gt(n),
          [a, l] = (function (e, t) {
            ...
            for (let [e, t] of a) yt(u, [e ?? "DEFAULT"], t);
      ...
      return l && "string" == typeof s && (s = Oe(s, l)), s ?? o;
    };
  }
  function bt(e, t) {
  ...
  function jt(e, t, r = null) {
    for (let n = 0; n < e.length; n++) {
      ...
      if (i) 0 === l ? n-- : (n += a - 1);
        ...
        if (2 === l) return 2;
        if (1 !== l && "function" === o.kind && 2 === jt(o.nodes, t, o))
          return 2;
      }
    }
  }
  ...
  function St(e) {
    ...
    return i.length > 0 && r.push(zt(i)), r;
  }
  ...
  function Et({
    ...
    let i = {
      addBase(r) {
        if (o) return;
        let i = Vt(r);
        (n.current |= Pe(i, e)), t.push(k("@layer", "base", i));
      },
      addVariant(t, r) {
        if (!Ge.test(t))
          throw new Error(
        ...
        "string" == typeof r || Array.isArray(r)
          ...
          : "object" == typeof r && e.variants.fromAst(t, Vt(r));
      },
      matchVariant(t, r, n) {
        function o(e, t, n) {
      ...
      addUtilities(r) {
        ...
        i = i.flatMap(([e, t]) => I(e, ",").map((e) => [e.trim(), t]));
        let a = new c(() => []);
        for (let [e, r] of i) {
        ...
        for (let [t, r] of a)
          e.theme.prefix &&
            ...
            e.utilities.static(t, (o) => {
              ...
              return Ot(i, t, o.raw), (n.current |= st(i, e)), i;
            });
      },
      matchUtilities(t, r) {
        let o = r?.type
        ...
        for (let [i, a] of Object.entries(t)) {
          let t = function ({ negative: t }) {
            return (l) => {
              ...
              c && null !== s && (u = Oe(u, s)), t && (u = `calc(${u} * -1)`);
              let f = Vt(a(u, { modifier: s }));
              return Ot(f, i, l.raw), (n.current |= st(f, e)), f;
            };
          };
          if (!Kt.test(i))
            throw new Error(
  ...
  function Vt(e) {
    ...
    for (let [e, n] of r)
      if ("object" != typeof n) {
        ...
        for (let r of n)
          "string" == typeof r ? t.push(y(e, r)) : t.push(b(e, Vt(r)));
      else null !== n && t.push(b(e, Vt(n)));
    return t;
  }
  function Nt(e, r) {
  ...
  var Dt = Ut((e) => {
      if (ye(e.value)) return e.value;
    }),
    _t = Ut((e) => {
      if (ye(e.value)) return `${e.value}%`;
    }),
    Mt = Ut((e) => {
      if (ye(e.value)) return `${e.value}px`;
    }),
    Bt = Ut((e) => {
      if (ye(e.value)) return `${e.value}ms`;
    }),
    Lt = Ut((e) => {
      if (ye(e.value)) return `${e.value}deg`;
    }),
    It = Ut((e) => {
      if (null === e.fraction) return;
      let [t, r] = I(e.fraction, "/");
      return ye(t) && ye(r) ? e.fraction : void 0;
    }),
    Rt = Ut((e) => {
      if (ye(Number(e.value))) return `repeat(${e.value}, minmax(0, 1fr))`;
    }),
    Pt = {
  ...
  function Gt(e, { config: t, base: r, path: n, reference: o }) {
    let i = [];
    ...
    for (let i of t.presets ?? [])
      Gt(e, { path: n, base: r, config: i, reference: o });
    for (let t of i)
      e.plugins.push(t),
        t.config &&
          Gt(e, {
  ...
  function Jt(e, t) {
    ...
    let n = (function ({ center: e, padding: t, screens: r }, n) {
      ...
      if (
        ...
        if ((e.sort((e, t) => re(e[1], t[1], "asc")), e.length > 0)) {
          let [t] = e[0];
          o.push(
        ...
        for (let [e, t] of Object.entries(r)) {
          ...
          i.set(e, k("@media", `(width >= ${t})`, [y("max-width", t)]));
        }
      }
        ...
        if ("@plugin" === e.name) {
          ...
          for (let t of e.nodes ?? []) {
            ...
            let e = I(t.value, ",").map((e) => {
              ...
              if ("{" === e[0] && "}" === e[e.length - 1])
                throw new Error(
                  `Unexpected \`@plugin\` option: Value of declaration \`${T([
                    t,
        ...
        e.utilities.static("bg-left-top", () => [
          ...
          e.utilities.functional("flex-shrink", (e) => {
            if (!e.modifier) {
              ...
              if (ye(e.value.value)) return [y("flex-shrink", e.value.value)];
            }
          }),
          e.utilities.functional("flex-grow", (e) => {
            if (!e.modifier) {
              ...
              if (ye(e.value.value)) return [y("flex-grow", e.value.value)];
            }
          }),
  ...
  function rr({
    ...
    let a = 0,
      ...
      { resolvedConfig: s } = Zt(e, [
        { config: qt(e.theme), base: t, reference: !0 },
        ...l,
        { config: { plugins: [Xt] }, base: t, reference: !0 },
      ]),
    ...
    let f,
      ...
      h = Et({ ...p, referenceMode: !1 });
    for (let { handler: e, reference: t } of s.plugins)
      t ? ((f ||= Et({ ...p, referenceMode: !0 })), e(f)) : e(h);
    if (
      (ft(e, c, u),
      Ft(e, c),
      (function (e, t) {
  ...
  function nr({ ast: e }) {
    let t = new c((e) =>
      ...
      r = new c((e) => ({ url: e.file, content: e.code, ignore: !1 })),
  ...
  async function cr(
    e,
    { base: t = "", from: r, loadModule: n = lr, loadStylesheet: a = sr } = {}
  ) {
    let l = 0;
    (e = [$({ base: t }, e)]), (l |= await ut(e, t, a, 0, void 0 !== r));
    let c = null,
      u = new s(),
      d = [],
      f = [],
      ...
      if ("at-rule" === e.kind) {
                  ...
                  A(e.nodes, (e) => {
                    ...
                    r.utilities.suggest(t.slice(0, -2), () => {
                      ...
                      for (let [
                        ...
                        if (a) o.push(...Ee);
                        else if (l) for (let e of Ee) ye(e) && o.push(e);
                        for (let e of r.theme.keysInNamespaces(s))
                          o.push(e.replace(De, (e, t, r) => `${t}.${r}`));
                      }
        ...
        if ("@source" === e.name) {
          ...
          if (i) {
            let e = o ? S : j,
              t = I(l, " ");
            for (let r of t) for (let t of ir(r)) e.push(t);
          } else C.push({ base: n.base, pattern: l, negated: o });
          return void r([]);
        }
        if (
          ("@variant" === e.name &&
        ...
        if ("@theme" === e.name) {
          ...
          return (
            ...
            g ? r([]) : ((g = w(":root, :host", [])), (g.src = e.src), r([g])),
            1
          );
        }
      }
    ...
    let E = tt(u);
    if ((c && (E.important = c), S.length > 0))
      for (let e of S) E.invalidCandidates.add(e);
    l |= await tr({
      designSystem: E,
      base: t,
      ast: e,
  ...
  async function ur(e, r = {}) {
    let n = t(e, { from: r.from }),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(
          x("! tailwindcss v4.1.8 | MIT License | https://tailwindcss.com ")
        );
        let u = new Set(),
          d = null,
          f = 0,
        ...
        return {
          ...
          build(o) {
            ...
            return (
              ...
              s || f !== m.length
                ? ((f = m.length), (a.nodes = m), (d = j(n, r, t.polyfills)), d)
    ...
    return {
      ...
      build(e) {
        let t = o.build(e);
        return t === i || ((a = T(t, !!r.from)), (i = t)), a;
      },
      buildSourceMap: () => nr({ ast: i }),
    };
  }
  var dr = {
    index:
          ...
          await (async function (e) {
            ...
            kr.end("Collect classes", { count: t.size }),
              (0 !== t.size || "incremental" !== e) &&
                ...
                (gr.textContent = fr.build(Array.from(t))),
